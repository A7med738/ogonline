-- إصلاح الجداول المفقودة في قاعدة البيانات
...
-- 3. إنشاء جدول profiles (إذا لم يكن موجود) أو إضافة العمود المفقود
DO $$ 
BEGIN
    ...
    ELSE
        -- إضافة العمود إذا كان الجدول موجود لكن بدون user_id
...
-- 7. إنشاء دالة لتحديث updated_at
...
SELECT 
  CASE 
    ...
    THEN 'تم إنشاء جميع الجداول المفقودة بنجاح! ✅'
    ELSE 'يوجد جداول لم يتم إنشاؤها'
  END as result;
