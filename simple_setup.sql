-- =============================================
-- إعداد مبسط لجميع الجداول والخدمات
-- =============================================
...
-- 9. إنشاء جدول الخدمات الجديدة إذا لم يكن موجوداً
...
-- 14. إنشاء جدول الصيدليات إذا لم يكن موجوداً
...
-- 16. تمكين RLS للصيدليات
ALTER TABLE public.pharmacies ENABLE ROW LEVEL SECURITY;

-- 17. حذف السياسات الموجودة للصيدليات
