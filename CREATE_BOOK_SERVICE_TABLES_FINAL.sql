...
-- 16. حذف السياسات الموجودة أولاً (إذا كانت موجودة)
...
DROP POLICY IF EXISTS "طوابير العيادات مرئية للجميع" ON book_service_clinic_queues;
DROP POLICY IF EXISTS "طوابير العيادات قابلة للتحديث للمديرين" ON book_service_clinic_queues;
DROP POLICY IF EXISTS "حالة الطابور مرئية للجميع" ON book_service_queue_status;
DROP POLICY IF EXISTS "حالة الطابور قابلة للتحديث للمديرين" ON book_service_queue_status;

-- 17. إنشاء سياسات الأمان للمراكز الصحية
...
-- 18. إنشاء سياسات الأمان للعيادات
...
-- 19. إنشاء سياسات الأمان للحجوزات
...
-- 20. إنشاء سياسات الأمان لطوابير العيادات
...
-- 21. إنشاء سياسات الأمان لحالة الطابور
