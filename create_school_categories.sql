...
INSERT INTO school_categories (name_ar, name_en, description_ar, description_en, color, icon, sort_order) VALUES
('مدارس حكومية', 'Government Schools', 'المدارس الحكومية التابعة لوزارة التربية والتعليم', 'Government schools under the Ministry of Education', '#10B981', 'school', 1),
('مدارس ناشونال', 'National Schools', 'المدارس الناشونال الخاصة', 'Private national schools', '#F59E0B', 'graduation-cap', 2),
('مدارس انترناشونال', 'International Schools', 'المدارس الدولية', 'International schools', '#8B5CF6', 'globe', 3)
