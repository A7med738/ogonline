        ...
        <div className="relative group/icon mb-3 mt-1 md:mt-0 flex items-center justify-center">
          <div className={`p-3 rounded-xl shadow-lg transition-all duration-300 ${
            title === "المال والأعمال" 
              ? "bg-gradient-to-br from-yellow-700 via-yellow-600 to-yellow-800 group-hover:shadow-yellow-600/30" 
              : "bg-gradient-to-br from-green-500 via-green-400 to-green-600 group-hover:shadow-green-500/30"
          }`}>
