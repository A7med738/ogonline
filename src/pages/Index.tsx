      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <div className="relative mb-8">
            <img 
              src={cityHeroImage} 
              alt="City skyline" 
              className="w-full max-w-md mx-auto rounded-3xl shadow-elegant animate-float"
            />
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 max-w-md mx-auto animate-scale-in" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="text-center mt-12 animate-fade-in" style={{ animationDelay: '1s' }}>
          <p className="text-white/70 text-sm">
            خدمة مقدمة من هيئة المدينة • متاح على مدار الساعة
          </p>
        </div>
      </div>
    </div>
