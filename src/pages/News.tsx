      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid gap-6 max-w-4xl mx-auto">
          {loading ? <div className="text-center py-8">
            ...
            </div> : newsData.length === 0 ? <div className="text-center py-8">
              <p className="text-muted-foreground">لا توجد أخبار متاحة حالياً</p>
            </div> : newsData.map((news, index) => <GlassCard key={news.id} className="animate-slide-up hover:scale-[1.02] transition-all duration-300" style={{
          animationDelay: `${index * 0.1}s`
                ...
                <div className="space-y-4">
                  ...
                  {/* News Image */}
                  {news.image_url && <div className="rounded-lg overflow-hidden">
                      <img src={news.image_url} alt={news.title} className="w-full h-48 object-cover transition-transform duration-300 hover:scale-105" />
                    </div>}
