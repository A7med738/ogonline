...
import { ArrowLeft, Scale, Phone, MapPin, Clock, FileText, Users, AlertCircle, Building } from 'lucide-react';
...
const CityServicesFamilyCourt = () => {
  const navigate = useNavigate();
  const [services, setServices] = useState<FamilyCourtService[]>([]);
  ...
  const fetchServices = async () => {
    try {
      ...
      console.error('Error fetching family court services:', error);
      toast.error('حدث خطأ أثناء تحميل خدمات نيابة الأسرة');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">لم يتم إضافة أي خدمات لنيابة الأسرة بعد</p>
          </div>
        ) : (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <CardDescription className="mt-1">
                        {service.description || 'خدمة نيابة الأسرة'}
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
...
export default CityServicesFamilyCourt;
