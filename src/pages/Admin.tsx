    ...
    <div className="min-h-screen bg-background pt-8">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 mb-8">
          ...
          <Card 
            className={`p-4 cursor-pointer transition-all hover:shadow-md ${activeTab === 'lost-found' ? 'ring-2 ring-primary' : ''}`}
            onClick={() => setActiveTab('lost-found')}
          >
            <div className="flex flex-col items-center text-center gap-2">
              <Activity className="h-8 w-8 text-orange-600" />
              <span className="text-sm font-medium">المفقودات</span>
            </div>
          </Card>

          <Card 
            className={`p-4 cursor-pointer transition-all hover:shadow-md ${activeTab === 'malls' ? 'ring-2 ring-primary' : ''}`}
          ...
          <Card 
            className={`p-4 cursor-pointer transition-all hover:shadow-md ${activeTab === 'educational' ? 'ring-2 ring-primary' : ''}`}
