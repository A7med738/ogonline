...
-- 5. حذف البيانات الموجودة أولاً (إذا كانت موجودة)
...
-- 6. إدراج بيانات تجريبية للمراكز الصحية
...
-- 7. إدراج بيانات تجريبية للعيادات
...
-- 9. حذف السياسات الموجودة أولاً (إذا كانت موجودة)
...
-- 10. إنشاء سياسات الأمان للمراكز الصحية
...
-- 11. إنشاء سياسات الأمان للعيادات
...
-- 12. إنشاء سياسات الأمان للحجوزات
...
-- 13. إنشاء سياسات الأمان للطوابير اليومية
