-- Add shop view counts system (Fixed Version)
...
DROP FUNCTION IF EXISTS increment_shop_view(UUID, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS get_shop_view_stats(UUID);
DROP FUNCTION IF EXISTS get_most_viewed_shops(UUID, INTEGER);
